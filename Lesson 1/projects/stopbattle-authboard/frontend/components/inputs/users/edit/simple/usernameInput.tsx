...
export default function UsernameInput() {
    ...
    const [username, setUsername] = useRecoilState(userCurrentUsernameState);
    const [usernameValid, setUsernameValid] = useRecoilState(userCurrentUsernameValidState);
    const [usernameError, setUsernameError] = useRecoilState(userCurrentUsernameErrorState);
