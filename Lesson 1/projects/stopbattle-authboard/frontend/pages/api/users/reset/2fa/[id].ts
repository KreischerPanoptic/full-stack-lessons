...
export default async function handler(
    ...
    console.log('Reset 2FA Next API Token', token);
    console.log('Reset 2FA Next API Request', request);
    let response = await UsersService.resetUserTOTP(request, token ? token : '');
    console.log('Reset 2FA Next API Response', response);
