...
export default async function handler(
    ...
    console.log('Get Lastname Hints Next API Token', token);
    console.log('Get Lastname Hints Next API Request', request);
    let response = await AutocompleteService.getLastNameHints(request, token ? token : '');
    console.log('Get Lastname Hints Next API Response', response);
