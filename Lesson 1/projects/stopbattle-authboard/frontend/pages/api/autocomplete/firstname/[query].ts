...
export default async function handler(
    ...
    console.log('Get Firstname Hints Next API Token', token);
    console.log('Get Firstname Hints Next API Request', request);
    let response = await AutocompleteService.getFirstNameHints(request, token ? token : '');
    console.log('Get Firstname Hints Next API Response', response);
