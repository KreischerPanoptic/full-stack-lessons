...
export default async function handler(
    ...
    console.log('Get Region Hints Next API Token', token);
    console.log('Get Region Hints Next API Request', request);
    let response = await AutocompleteService.getRegionHints(request, token ? token : '');
    console.log('Get Region Hints Next API Response', response);
