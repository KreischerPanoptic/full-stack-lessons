...
export default async function handler(
    ...
    console.log('Get Username Hints Next API Token', token);
    console.log('Get Username Hints Next API Request', request);
    let response = await AutocompleteService.getUsernameHints(request, token ? token : '');
    console.log('Get Username Hints Next API Response', response);
