...
export default async function handler(
    ...
    console.log('Is Password Passing Next API Token', token);
    console.log('Is Password Passing Next API Request', request);
    let response = await ValidateService.isPasswordSatisfyPolicy(request, token ? token : '');
    console.log('Is Password Passing Next API Response', response);
